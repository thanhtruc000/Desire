const autoChangImage = () => {
    const KichThuoc = document.getElementsByClassName("slide-collections")[0].clientWidth;
    const ChuyenSlide = document.getElementsByClassName("chuyen-slide-collections")[0];
